                                            ...
                                            <div id="grid-layout-table-1" class="box jplist">
                                                ...
                                                <div class="box text-shadow">
                                                    <table class="demo-tbl">
                                                        <!--<item>1</item>-->
                                                        @foreach($locations_all as $location_all)
                                                        <tr class="tbl-item">
                                                            
                                                            <!--<data></data>-->
                                                            <td class="td-block">

                                                                <p class="title" style="font-size: 25px;"><a href="/location_{{$location_all->location_id}}" style="color: #357ca5;">{{$location_all->name}}</a></p>

                                                                <p class="desc" style="font-size: 16px;"><a href="#" style="color: #00aff0;">{{$location_all->alternate_name}}</a></p>
